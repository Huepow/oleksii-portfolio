(() => {
  ...
  const I18N = {
    en: {
      ...
      bio5: "I also invent virtual-world concepts, design architecture that mixes futurism with ancient energy, and shoot metaverse mini-films inside hand-built worlds with a crew.",
      ...
      skill3body: "- concepts like VRIDIA, Blender architecture, metaverse film sets",
    ...
    de: {
      ...
      bio5: "Außerdem erfinde ich Konzepte für virtuelle Welten, entwerfe Architektur aus Futurismus und alter Energie und drehe Metaverse-Mini-Filme in handgebauten Welten mit einem Team.",
      ...
      skill3body: "- Konzepte wie VRIDIA, Blender-Architektur, Metaverse-Filmsets",
      skill4title: "Media Fusion",
