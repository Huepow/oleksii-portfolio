(() => {
  ...
  const I18N = {
    en: {
      ...
      bio5: "I also invent virtual-world concepts, design architecture that mixes futurism with ancient energy, shoot metaverse mini-films inside hand-built worlds with a crew, and experiment with Roblox worlds in Roblox Studio.",
      ...
      skill3body: "- concepts like VRIDIA, Blender architecture, metaverse film sets, Roblox worlds in Roblox Studio",
    ...
    de: {
      ...
      bio5: "Außerdem erfinde ich Konzepte für virtuelle Welten, entwerfe Architektur aus Futurismus und alter Energie, drehe Metaverse-Mini-Filme in handgebauten Welten mit einem Team und experimentiere mit Roblox-Welten in Roblox Studio.",
      ...
      skill3body: "- Konzepte wie VRIDIA, Blender-Architektur, Metaverse-Filmsets, Roblox-Welten in Roblox Studio",
      skill4title: "Media Fusion",
